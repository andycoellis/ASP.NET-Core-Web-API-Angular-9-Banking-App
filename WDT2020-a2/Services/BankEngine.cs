...
namespace WDT2020_a2.Services
{
    public class BankEngine
    {
        ...
        *--------------------------------------------------------------------*/
        ...
        /// <summary>Increment a Users password attempts given their UserID</summary>
        public void PasswordAttemptsIncrement(string id)
        {
            _loginService.PasswordAttemptsIncrement(id);

        }

        /// <summary>Reset a Users password attempts given their UserID</summary>
        public void PasswordAttemptsReset(string id)
        {
            _loginService.PasswordAttemptsReset(id);

        }

        /// <summary>Check if a Users Account is blocked, given their UserID</summary>
        public bool IsAccountBlocked(string id)
        {
            return _loginService.IsAccountLocked(id);

        }

        ///<summary>Lock a Users Account Given their UserID</summary>
        public void LockAccount(string userID)
        {
            _loginService.LockAccount(userID);
        }
        ...
        ///<summary>Returns a boolean if the BillPay is blocked, given the BillPayID</summary>
        public bool IsBillPayBlocked(int billPayID)
        {
            return _billPayService.IsBillPayActive(billPayID);
        }
